 ...
 */
final class Version20210324143558 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, state_id INT NOT NULL, playlist_id INT NOT NULL, token VARCHAR(255) NOT NULL, INDEX IDX_232B318C5D83CC1 (state_id), INDEX IDX_232B318C6BBD148 (playlist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318C6BBD148 FOREIGN KEY (playlist_id) REFERENCES playlist (id)');
